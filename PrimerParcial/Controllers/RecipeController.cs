...
namespace PrimerParcial.Controllers
{
    public class RecipeController : Controller
    {
        ...
        public RecipeController(RecetasDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,PreparationTimeMinutes,Servings,Instructions,CategoryId,DateCreated")] Recipe recipe)
        {
            if (id != recipe.Id)
            {
                return NotFound();
